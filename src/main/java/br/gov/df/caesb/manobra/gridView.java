...
public class gridView extends AppCompatActivity {
    ...
    public void recuReq() {
        try{
            ...
            lista = (ListView) findViewById(R.id.gridTeste);
            ...
            lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                    Intent intent = new Intent(gridView.this, Identificacao.class);
                    intent.putExtra("endereco", itens.get(position)) ;
...
//                    }
            ...
            while (cursor != null){
                itens.add(cursor.getString(inColEndereco));
                cursor.moveToNext();
